...
private:
  ...
  HeapWord* allocate_with_affiliation_and_access_rate(ShenandoahRegionAffiliation affiliation, ShenandoahRegionAccessRate access_rate, ShenandoahAllocRequest& req, bool& in_new_region);
