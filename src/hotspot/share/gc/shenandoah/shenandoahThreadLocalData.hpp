...
public:
  ...
  static PLAB* gclab(Thread* thread, ShenandoahRegionAccessRate access_rate) {
    switch(access_rate){
      case ShenandoahRegionAccessRate::HOT: return data(thread)->_hot_gclab;
      case ShenandoahRegionAccessRate::COLD: return data(thread)->_cold_gclab;
      case ShenandoahRegionAccessRate::NEUTRAL: return data(thread)->_gclab;
    }
    return NULL;
  }
  ...
  static size_t gclab_size(Thread* thread, ShenandoahRegionAccessRate access_rate) {
    switch(access_rate){
      case ShenandoahRegionAccessRate::HOT: return data(thread)->_hot_gclab_size;
      case ShenandoahRegionAccessRate::COLD: return data(thread)->_cold_gclab_size;
      case ShenandoahRegionAccessRate::NEUTRAL: return data(thread)->_gclab_size;
    }
  ...
  static void set_gclab_size(Thread* thread, ShenandoahRegionAccessRate access_rate, size_t v) {
    switch(access_rate){
      case ShenandoahRegionAccessRate::HOT:
        data(thread)->_hot_gclab_size = v;
        break;
      case ShenandoahRegionAccessRate::COLD:
        data(thread)->_cold_gclab_size = v;
        break;
      case ShenandoahRegionAccessRate::NEUTRAL:
