...
void ShenandoahConcurrentGC::vmop_entry_init_mark() {
  ...
  // Minh
  log_info(gc)("shenandoahConcurrentGC.cpp Virtual Op Init marking running");
  ...
  // Minh
  // log_info(gc)("%d", _do_old_gc_bootstrap);

  log_info(gc)("shenandoahConcurrentGC.cpp VMThread execute");
...
// Minh Init Marking Documentation
void ShenandoahConcurrentGC::entry_init_mark() {
  // start of init marking
  char msg[1024];
  ...
  // Minh
  log_info(gc)("In shenandoahConcurrentGC.cpp Init Mark running...");
